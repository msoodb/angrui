<template>
  <b-card no-header>
    ...
    <el-dialog ref="dialog" id="dialog"
      ...
      :show-close="false"
      top="1vh">
      <au-security-role ref="form" id="form" :record_id="record_id" @close="onClose"></au-security-role>
    </el-dialog>
  </b-card>
</template>
...
import AUSecurityRole from '../security_roles/SecurityRole'
...
export default {
  ...
  components: {
    'au-list': AUList,
    'au-security-role': AUSecurityRole
  },
  methods: {
    itemsChanged(items){
      this.items = items;
