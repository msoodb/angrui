...
export default {
  ...
  methods: {
    ...
    getItem(){
      ...
      this.$axios.get(baseurl() + '/users_publishers/' + id, config )
    ...
    addItem(){
      ...
      this.$axios.post(baseurl() + '/users_publishers', data_request, config )
        .then(function (response) {
          if(response.status == 200){
    ...
    updateItem(){
      ...
      var data_request = JSON.stringify(self.form);
      this.$axios.put(baseurl() + '/users_publishers/' + id, data_request, config )
        .then(function (response) {
          if(response.status == 200){
            let currentMsg =  self.$message  ({
