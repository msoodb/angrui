<template>
  <b-card no-header>
    ...
    <el-dialog ref="dialog" id="dialog"
      ...
      :show-close="false"
      top="1vh">
      <au-users_publisher ref="form" id="form" :record_id="record_id" @close="onClose"></au-users_publisher>
    </el-dialog>
  </b-card>
</template>
...
import AUUsersPublisher from '../users_publishers/UsersPublisher'
...
export default {
  ...
  components: {
    'au-list': AUList,
    'au-users_publisher': AUUsersPublisher
  },
  methods: {
    itemsChanged(items){
      this.items = items;
